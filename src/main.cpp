...
#include "18/part1/solver_18_part1.h"
#include "18/part2/solver_18_part2.h"
#include "19/part1/solver_19_part1.h"
...
#include "22/part1/solver_22_part1.h"
#include "22/part2/solver_22_part2.h"
...
int main(int argc, const char **argv)
{
  ...
  if (day == 1) {
    ...
    if (part == 1) {
      solver = new Solver_18_part1;
    } else if (part == 2) {
      solver = new Solver_18_part2;
    }
  } else if (day == 19) {
    if (part == 1) {
      solver = new Solver_19_part1;
    } else if (part == 2) {
      solver = new Solver_19_part2;
    }
  } else if (day == 20) {
    if (part == 1) {
    ...
    if (part == 1) {
      solver = new Solver_22_part1;
    } else if (part == 2) {
      solver = new Solver_22_part2;
    }
  }
